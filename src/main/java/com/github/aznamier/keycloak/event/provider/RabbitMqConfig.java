...
public class RabbitMqConfig {
    ...
    private String allowedAdminEvents;
    private String ignoredAdminEvents;
    private String allowedClientEvents;
    private String ignoredClientEvents;
    ...
    public String getAllowedAdminEvents() {
        return allowedAdminEvents;
    }

    public void setAllowedAdminEvents(String allowedAdminEvents) {
        this.allowedAdminEvents = allowedAdminEvents;
    }

    public String getIgnoredAdminEvents() {
        return ignoredAdminEvents;
    }

    public void setIgnoredAdminEvents(String ignoredAdminEvents) {
        this.ignoredAdminEvents = ignoredAdminEvents;
    }

    public String getAllowedClientEvents() {
        return allowedClientEvents;
    }

    public void setAllowedClientEvents(String allowedClientEvents) {
        this.allowedClientEvents = allowedClientEvents;
    }

    public String getIgnoredClientEvents() {
        return ignoredClientEvents;
    }

    public void setIgnoredClientEvents(String ignoredClientEvents) {
        this.ignoredClientEvents = ignoredClientEvents;
    }
}
